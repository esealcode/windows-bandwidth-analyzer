...
class WindowsBalloonTip:
    def __init__(self):
        ...
        wc.lpfnWndProc = message_map # could also specify a wndprocab.
...
if __name__ == '__main__':
    # Example
    w=WindowsBalloonTip()
    w.balloon_tip('Bandwith Usage', 'Chrome.exe seem to use 80% of Bandwith.')
    w.balloon_tip('Bandwith Usage', 'Steam.exe seem to use 50% of Bandwith.')